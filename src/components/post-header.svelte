<script lang="ts">
    ...
    function updateHover(isHovered: boolean) {
        showCopy = isHovered;
    }
...
<div class="post-header" role="complementary" onmouseenter={() => {updateHover(true)}} onmouseleave={() => {updateHover(false)}}>
    <div class="post-header__content">

        <h2 {id}>
            {name}
        </h2>
        {#if showCopy || mobileView}
        <a aria-label="Copy Header Link" class="post-header__link" href={headerUrl} onclick={copyLink}>
